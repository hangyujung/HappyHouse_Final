...
function displayChargeMarkers(places) {
	var fragment = document.createDocumentFragment();
    var bounds = new kakao.maps.LatLngBounds();
    var listStr = "";
	...
	var content = `
		<div class="overlaybox">
			...
			<ul>
				...
				<li>
					<span class="last" id="recenthistor" data-toggle="modal" data-target="#myModal">관심지역으로 등록</span>
				</li>
			</ul>
		</div>
	`;
...
/*$(document).ready(function(){
	$('#recenthistor').on('click',function(e){
